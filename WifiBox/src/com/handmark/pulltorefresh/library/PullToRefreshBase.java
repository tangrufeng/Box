...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	static final String TAG = PullToRefreshBase.class.getSimpleName();
	...
	protected final void refreshLoadingViewsSize() {
		...
		LOG.i(TAG, "maxNumPullScroll:" + maximumPullScroll);
	...
	protected void setHeaderScroll(final int value) {
		if (DEBUG) {
	...
	protected void updateUIForMode() {
		...
		if (this == mFooterLayout.getParent()) {
			...
			LOG.e(TAG, "removeFooterLayout");
			LOG.e(TAG, "childCount:" + getChildCount());
		}
		if (mMode.showFooterLoadingLayout()) {
			LOG.e(TAG, "showFooterLoadingLayout");
	 ...
	 * 默认能滑动的最大距离为高度除以一个权值
	 * 
	 * 但是高度在程序初始化的时候不能获取到，如果等获取到了值再改变的时候
	 * 可能会出现闪屏的情况
	 * @return
	 */
