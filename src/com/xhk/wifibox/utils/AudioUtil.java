...
import com.xhk.wifibox.model.MurmurHash;

public class AudioUtil {
    public final static String TAG = "XHK/AudioUtil";
    ...
    private static String getCoverFromVlc(Context context, Media media) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        if (artworkURL != null && artworkURL.startsWith("file://")) {
            ...
            if( mArtist.length() == 0 || mAlbum.length() == 0 ||
                mArtist.equals(XHKApplication.getAppContext().getString(R.string.unknown_artist)) ||
                mAlbum.equals(XHKApplication.getAppContext().getString(R.string.unknown_album)) )
            {
